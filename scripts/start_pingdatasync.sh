...
cp -R overlays/pingdirectory/* ./temp/PingDataSync/
...
./temp/PingDirectory/bin/manage-profile setup --licenseKeyFile ./licenses/PingDirectory.lic --profile ./temp/PingDataSync/pd.profile --useEnvironmentVariables
